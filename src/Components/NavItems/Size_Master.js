      ...
      renderCell: (params) => {
        return (
          <div className="">
            ...
            <button data-toggle="tooltip" title="Delete" style={{ marginLeft: '20%' }} className="btn btn-danger" onClick={() => {
        ...
        <form onSubmit={onFormSubmit} className="form-group">
          <div className="row mt-4">
            ...
            <div className="field col-md-4">
              ...
              <input placeholder="enter no of display" className="form-control mt-1" name="no_of_display" type="number" required />
            </div>
          </div>
