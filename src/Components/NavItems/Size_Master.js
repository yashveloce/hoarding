  ...
  const columns = [
...

    {
      ...
      renderCell: (params) => {
        return (
          <div className="">
            <button data-toggle="tooltip" title="Edit" onClick={() => onEdit(params.row)} type="button" className="btn btn-warning"  ><i className="bi bi-pencil-fill"> </i></button>
            <button data-toggle="tooltip" title="Delete" style={{ marginLeft: '20%' }} className="btn btn-danger" onClick={() => onDelete(params.row.id)} ><i className="bi bi-trash-fill"></i></button>
  ...
  return (
    ...
    <div>
      <Modal show={showModal} onHide={handleClose}>
        <Modal.Header>
          <Modal.Title style={{ marginLeft: "130px" }}>Edit Size Master</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <div className="col-md-4">
            <form className="form-group" onSubmit={(e) => { onModalFormSubmit(e) }}>
              <div className="field">
                <label>id</label>
                <input defaultValue={modalSize.id} onChange={(e) => { onModalInputChange(e) }} className="form-control" name="id" type="text" />
              </div>
              <div className="field">
                <label>height</label>
                <input defaultValue={modalSize.height} onChange={(e) => { onModalInputChange(e) }} className="form-control" name="height" type="number" />
              </div>
              <div className="field">
                <label>Width</label>
                <input defaultValue={modalSize.width} onChange={(e) => { onModalInputChange(e) }} className="form-control" name="width" type="number" />
              </div>
              <div className="field">
                <label>no_of_display</label>
                <input defaultValue={modalSize.no_of_display} onChange={(e) => { onModalInputChange(e) }} className="form-control" name="no_of_display" type="number" />
              </div>
              <div className="field">
