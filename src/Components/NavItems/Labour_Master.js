                                ...
                                <form className="form-group" onSubmit={onSubmit}>
                                    <div className="row">
                                        ...
                                        <div className="field col-md-4">
                                            <label className="required">Contact Number</label>
                                            <div style={{ display: 'flex' }}>
                                                <input className="form-control mt-1" name="mobile_no" type="tel"  onChange={onInputChange} placeholder="enter contact no" required  pattern="[789][0-9]{9}" title="Please enter valid mobile no"/>
                                                {/* <button className="btn btn-primary" style={{ margin: '0 20px' }} type='button'>Get OTP</button> */}
                                            </div>
                                        </div>
                                    </div><br />
                                    <div className="row mt-3">
                                        <div className="field col-md-4">
                                            <label className="required">GST Number</label>
                                            <input className="form-control mt-1" name="gst_no" type="text"placeholder="enter gst"  onChange={onInputChange} required />
                                        </div>
                                        {/* <div className="field col-md-6">
                                        <label>Enter OTP</label>
                                        <input className="form-control" name="otp" type="text" placeholder='Please Enter Your OTP' />
                                        ...
                                        <div className="field col-md-4">
                                            <label className="required">PAN Number</label>
                                            <input className="form-control mt-1" name="pan" type="text"placeholder="enter pan"  onChange={onInputChange} required />
                                        </div>
                                    ...
                                    <div className="row mt-3">
                                        <div className="field col-md-4 mt-3">
                                            <label className="required">IFSC</label>
                                            <label>Account Number</label>
                                            <input className="form-control mt-1" name="account_no" placeholder="enter account no" type="number"  onChange={onInputChange} required />
                                        </div>
                                    </div>
                                    <div className="field" style={{ width: '100%', textAlign: 'center', marginTop: '20px' }}>
