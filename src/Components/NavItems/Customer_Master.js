            ...
            <Card variant="outlined" className="form-card" style={{
                ...
                <form onSubmit={onFormSubmit} className="form-group" padding="2px">
                    ...
                    <div className="row">
                        <div className="field col-md-6">
                            <label className="required">Mobile Number</label>
                            <input onChange={onInputChange} placeholder="enter mobile no" type="tel" name="mobile_no" className="form-control mt-1" required  pattern="[789][0-9]{9}" title="Please enter valid mobile no"/>
                        </div>
                        <div className="field col-md-6">
                            <label className="required">Email ID</label>
                    ...
                    <div className="row">
                        <div className="field col-md-6">
                            <label className="required">GST Number</label>
                            <input onChange={onInputChange} placeholder="enter gst no" type="text" name="gst_no" className="form-control mt-1" pattern="^[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[1-9A-Z]{1}Z[0-9A-Z]{1}$" title="Please enter valid gstin" required />
                        </div>
                        <div className="field col-md-6">
                            <label className="required">PAN Number</label>
                            <input onChange={onInputChange} placeholder="enter pan" type="text" name="pan" className="form-control mt-1" pattern="[A-Z]{5}[0-9]{4}[A-Z]{1}" title="Please enter valid pan" required />
                        </div>
                    </div><br />
                    <div className="row">
                        <div className="field col-md-6">
