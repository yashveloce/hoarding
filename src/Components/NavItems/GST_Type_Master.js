                            ...
                            <form className="form-group" onSubmit={onModalSubmit}>
                                ...
                                <div className="row mt-3" >
                                    <div className="field col-md-4">
                                        <label>CGST</label>
                                        <input defaultValue={updateGST.cgst} className="form-control" name="cgst" type="number" onChange={onModalInputChange} required />
                                    </div>
                                    <div className="field col-md-4">
                                        <label>SGST</label>
                                        <input defaultValue={updateGST.sgst} className="form-control" name="sgst" type="number" onChange={onModalInputChange} required />
                                    </div>
                                    <div className="field col-md-4">
                                        <label>IGST</label>
                                        <input defaultValue={updateGST.igst} className="form-control" name="igst" type="number" onChange={onModalInputChange} required />
                                    </div>
                                </div>
