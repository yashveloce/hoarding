                    ...
                    <form onSubmit={onModalFormSubmit} className="form-group">
                        ...
                        <div className="row">
                            ...
                            <div className="field col-md-6">
                                ...
                                <input type="text" maxlength="11" minlength="11" defaultValue={modalEmployee.ifsc_code} className="form-control mt-1" onChange={onModalInputChange} name="ifsc_code" placeholder="enter ifsc code" />
                            </div>
                        </div>
                        <div className="row">
                            <div className="field col-md-6">
                                <label className="required">Account No</label>
                                <input type="text" defaultValue={modalEmployee.account_no} className="form-control mt-1" onChange={onModalInputChange} name="account_no" placeholder="enter account no" />
                            </div>
                        </div><br />
                        <div className="field col-md-6">
            ...
            <Card variant="outlined" className="form-card" style={{
                ...
                <form onSubmit={onFormSubmit} className="form-group" padding="2px">
                    ...
                    <div className="row">
                        <div className="field col-md-6">
                            <label className="required">Contact Number</label>
                            <input type="tel" name="contact_no" onChange={onInputChange} className="form-control mt-1" placeholder="enter contact no" required pattern="[789][0-9]{9}" title="Please enter valid mobile no" />
                        </div>
                        <div className="field col-md-6">
                            <label className="required">Email ID</label>
                    ...
                    <div className="row"><br />
                        <div className="field col-md-6">
                            <label className="required">IFSC Code</label>
                            <input type="text" maxlength="11" minlength="11" name="ifsc_code" onChange={onInputChange} className="form-control mt-1" placeholder="enter ifsc code" required />
                        </div>
                        <div className="field col-md-6">
                            <label className="required">Account No</label>
